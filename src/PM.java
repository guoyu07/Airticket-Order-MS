...
public class PM extends javax.swing.JFrame {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt)
		...
		if (n.equals("") || m.equals("")) {
			...
			jOptionPane1.showMessageDialog(null, "’À∫≈∫Õ√‹¬Î≤ªƒ‹Œ™ø’£°");
		...
		if (rs.next()) {
			if (n.equals(rs.getString("Account"))) {
				...
				jOptionPane1.showMessageDialog(null, "∏∂øÓ≥…π¶£°");
				stmt
						.executeUpdate("UPDATE take_info SET IfPay='“—∏∂øÓ' WHERE id LIKE '%*'");
				return;
			}

			else {

				jOptionPane1.showMessageDialog(null, "”√ªß√˚°¢√‹¬Î”Î…Ì∑›≤ª∆•≈‰£°£°");
				return;
			}
		} else {
